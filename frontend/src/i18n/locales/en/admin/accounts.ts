export default {
    accounts: {
      ...
      testPromptPlaceholder: 'Enter the prompt used to test this account connection',
      testPromptHint: 'Editable; this content is sent to the selected model when testing the connection.',
