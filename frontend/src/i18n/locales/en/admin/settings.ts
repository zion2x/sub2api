export default {
    settings: {
      ...
      upstreamBillingProbe: {
        ...
        description: 'Refresh account information declared by configured non-OAuth Sub2API and NewAPI upstreams. Account rates change only when the separate sync switch is enabled.',
